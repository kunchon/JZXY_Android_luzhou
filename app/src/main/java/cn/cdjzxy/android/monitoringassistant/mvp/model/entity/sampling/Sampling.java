...
public class Sampling {
    ...
    private String fileIds;//文件id的字符串，格式：ID1,ID2,ID3
    ...
    public Sampling(String Id, String ProjectId, String SamplingNo, String FormPath, String FormName,
                    ...
                    String SubmitDate, String MonitorPerson, String MonitorTime, int Status, String StatusName,
                    int TransStatus, String TransStatusName, String CurUserId, String CurUserName,
                    String FormFlows, String Comment, String AddTime, String UpdateTime,
                    int Version, String MonitemId, String MonitemName, String AuditDate,
                    String Recoding, String ProjectNo, String file, boolean isUpload, boolean isLocal,
                    boolean isCanEdit, boolean isFinish, boolean isUploadSave,
                    String layTableCheckbox, String DeleteFiles, String fileIds, List<String> SamplingUserResults) {
        this.Id = Id;
        this.ProjectId = ProjectId;
        this.SamplingNo = SamplingNo;
        this.FormPath = FormPath;
