package cn.cdjzxy.android.monitoringassistant.mvp.model.entity.upload;
...
public class PreciptationSampForm {
    ...
    private List<SampFormBean.SamplingFileBean> UploadFiles;
    ...
    public List<SampFormBean.SamplingFileBean> getUploadFiles() {
        return UploadFiles;
    }

    public void setUploadFiles(List<SampFormBean.SamplingFileBean> uploadFiles) {
