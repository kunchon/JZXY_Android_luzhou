...
import static cn.cdjzxy.android.monitoringassistant.luzhou.utils.RxFileTool.getDataColumn;
import static cn.cdjzxy.android.monitoringassistant.luzhou.utils.RxFileTool.isDownloadsDocument;
import static cn.cdjzxy.android.monitoringassistant.luzhou.utils.RxFileTool.isExternalStorageDocument;
import static cn.cdjzxy.android.monitoringassistant.luzhou.utils.RxFileTool.isGooglePhotosUri;
import static cn.cdjzxy.android.monitoringassistant.luzhou.utils.RxFileTool.isMediaDocument;
...
public class RxPhotoTool {
    ...
    public static Uri createImagePathUri(final Context context) {
        ...
        if (ContextCompat.checkSelfPermission(context, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED) {
            ...
            ArtUtils.makeText(context,"请先获取写入SDCard权限");
        } else {
