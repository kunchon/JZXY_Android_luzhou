...
import cn.cdjzxy.android.monitoringassistant.base.AppManager;
...
import cn.cdjzxy.android.monitoringassistant.utils.StackUtil;
import cn.cdjzxy.android.monitoringassistant.utils.rx.RxFileTool;
import cn.cdjzxy.android.monitoringassistant.widget.selector.SelectorDrawable;
...
public class AppLifecyclesImpl implements AppLifecycles, TitleBarViewControl {
    ...
    public void onCreate(@NonNull Application application) {
        ...
        RetrofitUrlManager.getInstance().putDomain(Api.TEMPORARY_SERVER_IP, BuildConfig.SERVER_IP);
    ...
    private class ExHandler implements Thread.UncaughtExceptionHandler {
        ...
        public void uncaughtException(Thread thread, Throwable ex) {
            File file = new File(RxFileTool.LOG_DIR);
            if (!file.exists()) {
                file.mkdirs();
            }
