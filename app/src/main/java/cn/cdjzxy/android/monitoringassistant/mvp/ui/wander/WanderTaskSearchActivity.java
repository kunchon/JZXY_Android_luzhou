...
import cn.cdjzxy.android.monitoringassistant.mvp.ui.adapter.SearchAdapter;
 ...
 * 流转任务搜索界面
 */
public class WanderTaskSearchActivity extends MyTitleActivity implements IView {
    ...
    private View getSearchView() {
        ...
        mBtnSearch.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (!RxDataTool.isEmpty(mEtSearch.getText().toString())) {
    ...
    private void initTypeView() {
        ...
        mSearchTypeAdapter = new SearchAdapter(mTaskTypes,mContext);
    ...
    private void initHistoryView() {
        ...
        mSearchHistoryAdapter = new SearchHistoryAdapter(mHistoryList,mContext, new SearchHistoryAdapter.OnDeleteClickListener() {
            @Override
    ...
    private void initWanderView() {
        wanderList = new ArrayList<>();
        wanderAdapter = new WanderTaskAdapter(wanderList,mContext);
